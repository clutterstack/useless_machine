...
![Screenshot: Title "You started a Useless Machine", message "This is Fly Machine 7811eedf292108 in Toronto", then a text-based image of a hand emerging from a trap door, about to push a button](./docs/images/almost.png)
